        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/adverts/show/f?') }}" class="text-sm text-gray-700 underline">Buscar</a>
                    @else
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <img width="100px" src="{{ asset('tu.png') }}" alt="">
                    <h1 style="color: #EF4444" class="text-5xl font-black p-6">TuOferta.com</h1>
                </div>
                <h1 class="text-lg dark:text-white">¿Donde te encuentras?</h1>
                @livewire('map-departamentos')
